...
namespace TwoDee
{
    public class Math3d
    {
        ...
        public static Vector3 FromLengthAngleDegrees2D(float length, float angle)
        {
            return new Vector3(Mathf.Cos(angle * Mathf.Deg2Rad) * length, Mathf.Sin(angle * Mathf.Deg2Rad) * length, 0.0f);
        }
        ...
        public static bool LineLineIntersection2(out Vector3 intersection, Vector3 linePoint1, Vector3 lineVec1, Vector3 linePoint2, Vector3 lineVec2)
        {
        ...
        public static bool LineLineIntersection(ref Vector3 intersection, Vector3 linePoint1, Vector3 lineVec1, Vector3 linePoint2, Vector3 lineVec2)
        {
            var closestPointLine1 = Vector3.zero;
            var closestPointLine2 = Vector3.zero;
            ...
            if (d != 0.0f)
            {
                ...
                if (s > -0.01f && s < 1.01f)
                {
                    intersection = closestPointLine1;
                    return true;
                }
                if (t > -0.01f && t < 1.01f)
                {
                    intersection = closestPointLine2;
                    return true;
                }
        ...
        public static float DistanceToLineSegment(Vector3 linePoint1, Vector3 linePoint2, Vector3 point)
        {
            var projected = ProjectPointOnLineSegment(linePoint1, linePoint2, point);
